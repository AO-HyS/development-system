...
const catalog = await read("catalog/0.30.0.json");
catalog.catalogVersion = catalogVersion;
for (const name of ["coding-orchestration", "drive-development-flow", "flow-implement", "measure-development-run"]) {
...
const manifest = await read("manifests/1.9.0.json");
