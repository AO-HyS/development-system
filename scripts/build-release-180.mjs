...
const catalog = await read("catalog/0.28.0.json");
catalog.catalogVersion = catalogVersion;
for (const name of ["working-backwards", "show-me", "flow-implement", "flow-code-review", "drive-development-flow"]) {
...
const manifest = await read("manifests/1.7.0.json");
