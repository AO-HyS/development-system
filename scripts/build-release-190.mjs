...
const catalog = await read("catalog/0.29.3.json");
catalog.catalogVersion = catalogVersion;
for (const name of ["working-backwards", "flow-implement"]) {
...
const manifest = await read("manifests/1.8.3.json");
