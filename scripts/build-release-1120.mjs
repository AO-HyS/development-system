...
const catalog = await read("catalog/0.32.1.json");
catalog.catalogVersion = catalogVersion;
for (const name of ["coding-orchestration", "drive-development-flow", "flow-implement", "pstack-engineering", "parallel-work", "flow-code-review"]) {
...
const manifest = await read("manifests/1.11.1.json");
manifest.contractVersion = version;
const changedAgents = ["code-mapper", "implementer", "fast-implementer", "mechanical-worker", "test-runner", "evidence-preparer"];
