...
const catalog = await read("catalog/0.40.1.json");
...
const manifest = await read("manifests/1.19.1.json");
...
packageJson.scripts["release:prepare"] = "node ./scripts/build-release-1200.mjs";
