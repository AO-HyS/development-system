...
const catalog = await read("catalog/0.35.0.json");
catalog.catalogVersion = catalogVersion;
for (const name of ["coding-orchestration"]) {
...
const manifest = await read("manifests/1.14.0.json");
