...
const catalog = await read("catalog/0.29.1.json");
catalog.catalogVersion = catalogVersion;
for (const name of ["coding-orchestration", "drive-development-flow", "flow-implement", "flow-code-review"]) {
...
const manifest = await read("manifests/1.8.1.json");
