...
const catalog = await read("catalog/0.36.0.json");
catalog.catalogVersion = catalogVersion;
for (const name of ["coding-orchestration", "design-direction", "design-quality", "evidence-capture", "grill-with-docs", "implement-spec"]) {
...
const manifest = await read("manifests/1.15.0.json");
