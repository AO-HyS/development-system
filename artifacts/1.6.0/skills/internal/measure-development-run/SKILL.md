...
- Optimize elapsed time to a verified useful outcome first, correctness through
  proportional risk gates second, and cost third. Report failures and rework;
  unsafe or unverified output never counts as a successful fast delivery.
