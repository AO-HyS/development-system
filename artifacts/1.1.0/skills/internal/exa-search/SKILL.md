...
```bash
EXA_SKILL_DIR="${EXA_SKILL_DIR:-$HOME/.agents/skills/exa-search}"
node "$EXA_SKILL_DIR/scripts/exa-search.mjs" search --query "current public question"
node "$EXA_SKILL_DIR/scripts/exa-search.mjs" search --query "comparison" --type deep --num-results 8
node "$EXA_SKILL_DIR/scripts/exa-search.mjs" request --input /absolute/path/request.json
node "$EXA_SKILL_DIR/scripts/exa-search.mjs" search --query "preview" --dry-run
```
