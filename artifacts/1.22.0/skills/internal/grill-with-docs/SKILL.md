...
references or an initial comparison before asking the user to invent an abstract
style vocabulary. Do not require the complete application's functional contract
before producing a useful bounded visual exploration. If all proposals are
rejected, record the correction and prepare a materially revised comparison;
rejection is not approval and does not force a choice.
...
preserve the selected direction. Reuse the same decision keys without a second
interview. Before creating specs or tickets, complete its visual handoff: selected
