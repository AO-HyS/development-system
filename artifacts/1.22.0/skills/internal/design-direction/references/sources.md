...
candidates before seed use; present equal-data comparisons; reuse one interview;
and distinguish comparison readiness from user selection. Use installed provider
...
not reload the article during ordinary work.
