---
name: design-quality
description: Judge rendered UI against an approved design and resolve visual critique before final evidence.
---
...
1. Identify the surface, user task and incumbent visual language. For unresolved
   direction, use `design-direction`; read [direction.md](references/direction.md)
   only when more exploration guidance is needed. For refinement,
