...
Review the objective and diff; use independent Astra review for complex independent judgment.
...
Astra judges behavior and, with `design-quality`, the visual result. A backend
