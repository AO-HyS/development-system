 ...
 * @param {{codexPath: string, promptPath: string, reportPath: string, workingDirectory: string, stewardContractPath: string, checkInContractPath: string, runCodex?: typeof spawnCodex}} options
 */
export async function runDevelopmentSteward(options) {
  ...
  try {
    const result = await runCodex({ command: codexPath, args, cwd: workingDirectory, outputPath: rawOutput });
