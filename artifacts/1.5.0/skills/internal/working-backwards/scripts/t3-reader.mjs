...
.reader-topbar{position:sticky;z-index:40;top:0;display:flex;align-items:center;justify-content:space-between;gap:1rem;min-height:3.5rem;padding:.55rem clamp(1rem,2.2vw,2rem);border-bottom:1px solid color-mix(in srgb,var(--line) 72%,transparent);background:color-mix(in srgb,var(--page) 96%,transparent)}.reader-identity,.reader-actions{display:flex;align-items:center;gap:.65rem;min-width:0}.reader-mark{display:grid;place-items:center;width:1.65rem;height:1.65rem;border:1px solid var(--accent);border-radius:50%;color:var(--accent);font-size:.62rem;font-weight:750;letter-spacing:.02em}.reader-identity{font-size:.84rem}.reader-identity strong,.reader-identity span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.reader-identity>span:last-child{color:var(--muted);font-size:.8rem}.reader-actions{justify-content:flex-end}.authority-state{display:inline-flex;align-items:center;gap:.45rem;color:var(--muted);font-size:.76rem}.authority-state::before{content:"";width:.44rem;height:.44rem;border-radius:50%;background:var(--warn)}.source-button{display:inline-flex;align-items:center;min-height:2.5rem;padding:.25rem .65rem;border-radius:.35rem;color:var(--muted);font-size:.78rem;text-decoration:none}.source-button:hover{color:var(--ink);background:var(--accent-soft)}.icon-button{display:grid;place-items:center;min-width:2.5rem;min-height:2.5rem;border:0;border-radius:.35rem;background:transparent;cursor:pointer}.icon-button:hover{background:var(--accent-soft)}
.reader-layout{display:grid;grid-template-columns:minmax(11rem,14rem) minmax(0,56rem) minmax(10rem,13rem);align-items:start;gap:clamp(1rem,2.5vw,3rem);max-width:92rem;margin:0 auto;padding:0 clamp(1rem,2vw,2rem)}.document-column{position:relative;grid-column:2;min-width:0;padding:clamp(3rem,6vw,5.25rem) clamp(1rem,3vw,2.5rem) 7rem}.document-column::before{content:"";position:absolute;inset:1.75rem 0 3rem;border-radius:.9rem;background:var(--document);box-shadow:0 0 0 1px color-mix(in srgb,var(--line) 42%,transparent);pointer-events:none}.artifacts-rail{grid-column:1;grid-row:1}.toc-rail{grid-column:3;grid-row:1}.artifacts-rail,.toc-rail{position:sticky;top:3.5rem;max-height:calc(100vh - 3.5rem);overflow:auto;padding:2.5rem 0;color:var(--muted)}.artifacts-rail{padding-left:.2rem}.toc-rail{padding-right:.2rem}
.document-header,.document-body{position:relative}
.rail-label{display:flex;justify-content:space-between;gap:.5rem;margin:0 0 1rem;color:var(--faint);font-size:.74rem;font-weight:650}.artifact-list,.toc-list{list-style:none;margin:0;padding:0}.artifact-link{position:relative;display:grid;grid-template-columns:1.5rem minmax(0,1fr);gap:.65rem;align-items:center;min-height:2.75rem;margin:.15rem 0;padding:.58rem .25rem .58rem .7rem;border-radius:0;color:var(--muted);text-decoration:none}.artifact-link::before{content:"";position:absolute;left:0;top:.72rem;bottom:.72rem;width:1px;background:transparent}.artifact-link:hover{color:var(--ink)}.artifact-link strong,.artifact-link small{display:block}.artifact-link strong{color:inherit;font-size:.84rem;font-weight:580;line-height:1.28}.artifact-link small{margin-top:.14rem;color:var(--faint);font-size:.72rem;line-height:1.35;overflow-wrap:anywhere}.artifact-marker{display:grid;place-items:center;width:1.45rem;height:1.45rem;border:0;border-radius:50%;background:transparent;font-size:.66rem;font-weight:650}.artifact-link.is-complete .artifact-marker{color:var(--ok)}.artifact-link.is-active{background:transparent;color:var(--ink)}.artifact-link.is-active::before{background:var(--accent)}.artifact-link.is-active .artifact-marker{background:var(--accent-soft);color:var(--accent)}.artifact-link.is-pending{opacity:.72}
.rail-action,.gate-card{margin-top:1.35rem;padding-top:1rem;border-top:1px solid var(--line);font-size:.78rem}.rail-action strong,.gate-card strong,.rail-action span,.gate-card span{display:block}.rail-action strong,.gate-card strong{margin:.25rem 0;color:var(--ink);font-size:.84rem;line-height:1.35}.toc-link{display:block;margin:.08rem 0;padding:.45rem .3rem .45rem .75rem;border-left:1px solid var(--line);color:var(--muted);font-size:.8rem;text-decoration:none}.toc-link.level-3{padding-left:1.15rem;font-size:.77rem}.toc-link:hover,.toc-link.is-active{background:transparent;color:var(--ink);border-left-color:var(--accent)}
.document-header{padding:0 0 2.4rem;border-bottom:1px solid var(--line)}.document-kicker{display:flex;align-items:center;flex-wrap:wrap;gap:.55rem;color:var(--muted);font-size:.8rem;font-weight:620}.status-chip,.priority-chip{display:inline-flex;align-items:center;min-height:1.6rem;padding:.16rem .55rem;border-radius:999px}.status-chip{background:var(--accent-soft);color:var(--accent)}.priority-chip{border:1px solid var(--line)}h1{max-width:19ch;margin:1rem 0 .9rem;font-size:clamp(2rem,4vw,2.75rem);line-height:1.08;letter-spacing:-.025em;text-wrap:balance}.document-summary{max-width:68ch;margin:0;color:var(--muted);font-size:1.08rem;line-height:1.65}.document-meta{display:flex;flex-wrap:wrap;gap:.8rem 1.4rem;margin:1.5rem 0 0}.document-meta div{display:flex;align-items:baseline;gap:.35rem;min-width:0}.document-meta dt{color:var(--faint);font-size:.74rem;font-weight:560}.document-meta dd{margin:0;font-size:.78rem;overflow-wrap:anywhere}.document-body{padding-top:2.45rem}.document-body>p,.document-body>ul,.document-body>ol,.document-body>blockquote{max-width:70ch}.document-body h2,.document-body h3,.document-body h4{scroll-margin-top:5.4rem;text-wrap:balance}.document-body h2{margin:3.75rem 0 .85rem;font-size:1.55rem;line-height:1.22;letter-spacing:-.015em}.document-body h3{margin:2.7rem 0 .7rem;font-size:1.2rem;line-height:1.32}.document-body h4{margin:2rem 0 .5rem;font-size:1rem}.document-body p{margin:.7rem 0 1.1rem}.document-body li{margin:.42rem 0}.document-body code:not(.code-block code){padding:.08em .3em;border-radius:.25rem;background:var(--surface-2);font-family:"Monaspace Neon",monospace;font-size:.82em;font-variant-ligatures:contextual common-ligatures discretionary-ligatures}.document-body blockquote{margin:1.5rem 0;padding:.2rem 0 .2rem 1rem;border-left:1px solid var(--accent);color:var(--muted)}.document-body hr{margin:3rem 0;border:0;border-top:1px solid var(--line)}
.visual-block,.code-block,.table-scroll{width:100%;margin:2rem 0 2.4rem;transform:none;border:1px solid var(--line);border-radius:.7rem;background:var(--surface);overflow:hidden}.visual-block figcaption,.code-block figcaption{display:flex;align-items:center;justify-content:space-between;gap:1rem;min-height:3.5rem;padding:.55rem .75rem;color:var(--muted);font-size:.8rem}.visual-block figcaption>div,.code-block figcaption>div{display:flex;align-items:center;gap:.55rem;min-width:0}.visual-block figcaption strong,.code-block figcaption strong{color:var(--ink);overflow-wrap:anywhere}.visual-title{display:flex;align-items:baseline;gap:.55rem}.visual-title strong{font-weight:650}.visual-title span{color:var(--faint);font-family:"Monaspace Neon",monospace;font-size:.72rem}.visual-actions{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:.1rem}.visual-actions button,.code-block button{min-width:2.5rem;min-height:2.5rem;padding:.3rem .58rem;border:0;border-radius:.35rem;color:var(--muted);background:transparent;font-size:.75rem;cursor:pointer}.visual-actions button:hover,.code-block button:hover{color:var(--ink);background:var(--accent-soft)}
.diagram-viewport{position:relative;display:grid;place-items:center;min-height:clamp(20rem,44vw,30rem);overflow:hidden;padding:1.25rem;border-top:1px solid var(--line);background:var(--diagram-bg);overscroll-behavior:contain;touch-action:none;cursor:grab}.diagram-viewport:active{cursor:grabbing}.diagram-canvas{display:grid;place-items:center;width:100%;min-width:0;min-height:17rem;transform:none}.diagram-canvas svg{display:block;height:auto;max-height:none;overflow:visible;font-family:"Atkinson Hyperlegible Next",sans-serif}.diagram-loading{position:absolute;color:var(--faint);font-family:"Monaspace Neon",monospace;font-size:.78rem}.diagram-source{padding:.55rem .85rem;border-top:1px solid var(--line);color:var(--muted);font-size:.78rem}.diagram-source summary{display:flex;align-items:center;min-height:2.5rem;cursor:pointer}.diagram-source pre{max-height:22rem;margin:.6rem 0 0;padding:1rem;border-radius:.45rem;background:var(--code);color:var(--code-ink);font:400 .8rem/1.65 "Monaspace Neon",monospace;overflow:auto}.diagram-error{place-self:stretch;padding:1.25rem;color:var(--risk);background:color-mix(in srgb,var(--risk) 7%,var(--diagram-bg))}.diagram-error p{margin:.35rem 0 0;color:var(--muted)}
...
.chart-viewport{overflow:auto;padding:.8rem;border-top:1px solid var(--line);background:var(--diagram-bg)}.chart-viewport svg{display:block;width:100%;height:auto}.chart-grid line{stroke:var(--line)}.chart-grid text,.chart-label{fill:var(--muted);font-family:"Atkinson Hyperlegible Next",sans-serif}.chart-bar{fill:var(--accent)}.chart-line{fill:none;stroke:var(--accent);stroke-width:4;stroke-linecap:round;stroke-linejoin:round}.chart-dot{fill:var(--surface);stroke:var(--accent);stroke-width:3}.chart-data-table,.data-table{width:100%;border-collapse:collapse;font-size:.86rem}.chart-data-table caption{padding:.6rem .8rem;color:var(--muted);text-align:left}.chart-data-table th,.chart-data-table td,.data-table th,.data-table td{padding:.6rem .7rem;border-top:1px solid var(--line);text-align:left}.chart-data-table th,.data-table th{color:var(--muted);font-weight:650}.chart-data-table tbody th{color:var(--ink)}.table-scroll{overflow:auto}.data-table{min-width:34rem}.data-table thead{position:sticky;top:0;background:var(--surface)}
.code-block{background:var(--code);color:var(--code-ink)}.code-block figcaption{border-bottom:1px solid #2c342f;background:color-mix(in srgb,var(--code) 80%,var(--surface))}.code-block figcaption span{color:#9aa6a0;font-size:.74rem}.code-block pre{margin:0;padding:.9rem 0;overflow:auto;tab-size:2}.code-block code{display:block;min-width:max-content;font-family:"Monaspace Neon",monospace;font-size:.82rem;line-height:1.68;font-variant-ligatures:contextual common-ligatures discretionary-ligatures}.code-line{display:grid;grid-template-columns:3.4rem minmax(max-content,1fr);min-height:1.7em}.line-number{padding-right:.9rem;color:#85918b;text-align:right;user-select:none}.line-source{padding-right:1.2rem;white-space:pre}.code-line.is-highlighted{background:#17333b}.code-line.diff-added{background:#173528}.code-line.diff-removed{background:#3b2024}.code-wrap code{min-width:0}.code-wrap .line-source{white-space:pre-wrap;overflow-wrap:anywhere}.copy-status{display:block;min-height:1.3rem;padding:.2rem .8rem;color:var(--muted);font-size:.74rem}
...
@media(max-width:76rem){body{padding-bottom:4rem}.reader-layout{display:block;max-width:none;padding:0}.document-column{max-width:58rem;margin:0 auto;padding:2.75rem clamp(1rem,5vw,3rem) 5.5rem}.document-column::before{inset:1rem 0 2rem}.artifacts-rail,.toc-rail{display:none}.mobile-reader-tools{position:fixed;z-index:60;right:0;bottom:0;left:0;display:grid;grid-template-columns:1fr 1fr;border-top:1px solid var(--line);background:var(--document)}.mobile-reader-tools details{position:relative}.mobile-reader-tools summary{display:flex;align-items:center;justify-content:center;min-height:3.6rem;padding:.5rem;color:var(--muted);cursor:pointer;list-style:none}.mobile-reader-tools summary::-webkit-details-marker{display:none}.mobile-reader-tools details[open] summary{color:var(--accent);background:var(--accent-soft)}.mobile-panel{position:fixed;right:.75rem;bottom:4.35rem;left:.75rem;max-height:min(70vh,34rem);overflow:auto;padding:1rem;border:1px solid var(--line);border-radius:.7rem;background:var(--document);box-shadow:var(--shadow)}.mobile-panel .artifact-link{grid-template-columns:1.65rem 1fr}.mobile-panel .toc-link{padding:.55rem}.document-meta{grid-template-columns:none}}
@media(max-width:42rem){.reader-topbar{padding:.5rem .75rem}.reader-identity>span:last-child,.authority-state,.reader-actions>.source-button{display:none}.document-column{padding:2rem 1rem 5.25rem}.document-column::before{inset:.5rem 0 1rem;border-radius:.65rem}h1{font-size:clamp(1.9rem,9vw,2.45rem)}.document-summary{font-size:1.02rem}.document-meta{gap:.45rem 1rem}.visual-block figcaption,.code-block figcaption{align-items:flex-start;flex-direction:column}.visual-actions{justify-content:flex-start;width:100%}.visual-actions button{flex:1 1 auto;font-size:.72rem}.diagram-viewport{min-height:21rem;padding:.65rem}.mermaid-block.is-expanded{inset:.35rem}.chart-data-table th,.chart-data-table td,.data-table th,.data-table td{padding:.55rem}}
...
<body>
  ...
  <header class="reader-topbar">
    ...
    <div class="reader-actions"><span class="authority-state" title="${escapeHtml(authorizationLabel)}">${escapeHtml(authorizationLabel)}</span>${libraryButton}${sourceButton}<button class="icon-button" type="button" data-theme-toggle aria-label="Toggle light and dark theme" aria-pressed="false"><span aria-hidden="true">◐</span></button></div>
  </header>
