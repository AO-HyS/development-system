# Development System Contract 1.14.0
...
Codex are the only active providers. Luna uses Max with priority requested for
execution and bounded evidence preparation. Astra handles independent review.
...
Request Astra Medium for orchestration by default, Low for explicitly selected
simple work and High for difficult specialist judgment. Active host evidence establishes the effective effort.
...
Catalog 0.33.0 includes the Jakub interface skills, make-interfaces-feel-better,
