...
6. Astra owns UI design, visual craft, visual review and Computer Use. Use the installed Development System roster for task-specific effort; OpenCode Go handles bounded implementation; Codex Luna uses role-specific effort with priority as the alternative, and Astra owns independent review. Only OpenCode Go and Codex are active providers.
