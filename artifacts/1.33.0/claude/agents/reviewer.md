---
name: reviewer
description: "Default reviewer for plans, diffs and security: a plan before writers start, an integrated change against its requirements (correctness, regressions, authorization and data boundaries, requirements quietly skipped), and security review of auth, roles and data boundaries. Use this, not the Fable reviewers, unless the work is a very large spec."
model: opus
effort: high
