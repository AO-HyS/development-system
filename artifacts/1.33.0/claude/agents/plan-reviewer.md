---
name: plan-reviewer
description: "Fable 5.1, the most expensive model, used minimally: plan and result review only for very large or ultra-hard specs that touch many surfaces. Everything else goes to reviewer (Opus high). Allowed when Jev picks the fable tier or the packet has a \"Fable scope:\" line."
model: fable
effort: high
