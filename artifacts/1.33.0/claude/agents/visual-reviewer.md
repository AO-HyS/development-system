...
description: "Fresh, single-use visual review of one slice (up to four screens): compares each approved mock with the live page captures named in the packet and returns text findings per screen. The only role that compares images."
model: opus
effort: high
