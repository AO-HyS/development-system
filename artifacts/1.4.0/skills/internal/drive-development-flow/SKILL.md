...
| In T3 Code, the user invokes `working-backwards` / `work backwards`, or asks for future customer experience, Amazon Working Backwards, PRFAQ/customer story, or one planning document at a time | `working-backwards` |
