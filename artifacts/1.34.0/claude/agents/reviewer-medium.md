...
description: "Fallback only when Codex fails or has no quota (packet needs a `Codex fallback:` line): Opus medium review of a small or medium diff or plan against its requirements: correctness, regressions and requirements quietly skipped. Large diffs and authorization or data-boundary review go to reviewer (Opus high)."
model: opus
effort: medium
