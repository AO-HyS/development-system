...
Resolve lane models and descendant capabilities through
...
or unresolved risk. Logical review phases do not require separate agents; the
orchestrator reviews ordinary work and requests an independent capable reviewer
for complex or adversarial review.
