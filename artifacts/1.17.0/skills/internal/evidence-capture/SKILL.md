...
Resolve the orchestrator and browser-capable role through
`coding-orchestration`'s Session selection and role ownership section.

1. For final delivery, require completed Impeccable work and independent
   visual-capable critique with findings resolved on this candidate
   (`design-quality`).
