# Development System Contract 1.11.1
...
review. Luna is the final general fast-worker fallback and may prepare bounded evidence
scripts or media through the dedicated evidence-preparation route. Sol has no active route.
...
Request Astra Low for clear orchestration, Medium for ambiguity and High for
difficult judgment. Active host evidence establishes the effective effort.
...
Catalog 0.31.0 includes the Jakub interface skills, make-interfaces-feel-better,
...
Non-trivial development closure generates a private completion document before
the final response, unless the user opts out. On-demand review and spec
...
Published artifacts and manifests through 1.9.0 remain immutable rollback
