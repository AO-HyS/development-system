...
Codex routes bounded implementation to Spark, discovery/planning/focused tests
to Luna, browser QA to Terra, and uses Sol only for work needing its judgment.
