...
const messages = Object.freeze({
  ...
  "lock-timeout": ["Governance lock contention exceeded the bounded wait.", "Retry after the current transaction completes; preserve the lock and its receipts."],
  "lock-unknown": ["Governance lock ownership or mutex integrity could not be established.", "Preserve the lock and inspect its private metadata; verify the same host, local filesystem and owner before supported recovery."],
  "lock-runtime-unavailable": ["This Node runtime cannot provide the required SQLite lock mutex.", "Use a Node runtime with node:sqlite DatabaseSync available, then retry; do not remove the lock."],
  "lock-recovery-failed": ["Governance lock recovery could not retain a complete evidence receipt.", "Preserve the private recovery directory and original lock evidence; repair the failed storage or receipt before retrying."],
  "lock-release-failed": ["Governance lock release could not verify or remove its own lock.", "Preserve the current lock and recovery evidence; inspect ownership before retrying the operation."],
