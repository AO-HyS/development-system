...
description: Define a software feature through PRFAQ and staged documents when the user requests working backwards before coding.
---
...
The spec links every ticket, and governed implementation retrieves and tracks
...
whole-spec request. A later authorized whole-feature implementation creates a
governance run containing every linked ticket, retains the definition receipts
