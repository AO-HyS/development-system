# Development System Contract 1.5.18

Version 1.5.18 preserves the immutable 1.5.17 contract and catalog 0.24.0,
the fast-model-first route, the independent Fable/Sol reviewer route, and
every executable anti-slop lane contract. Catalog 0.25.0 replaces only two
...
## Skill catalog 0.25.0 probe reliability patch

Catalog `0.25.0` reuses the exact skill payloads and provenance from 0.24.0.
...
Repository initialization and normalization record Development System 1.5.18,
skill catalog `0.25.0`, and the same executable anti-slop lane contract
