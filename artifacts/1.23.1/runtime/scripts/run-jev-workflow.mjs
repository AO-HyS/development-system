...
export async function runWorkflow(config, runtime = {}) {
  ...
  try {
    ...
    await json(resolve(directory, 'manifest.json'), { ...config, ticket, acceptanceIds, requiresVisualReview, planningMode, packetization, concurrency: capacity, coordinator, startedAt: new Date().toISOString(), controllerVersion: '1.23.1' });
