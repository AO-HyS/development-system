# Development System Contract 1.23.1
...
The driver records its selected options and controllerVersion 1.23.1. Model
...
harness and mirror relationship in `manifests/1.23.1.json`. Sources must match
