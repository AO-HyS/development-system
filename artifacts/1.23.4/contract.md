# Development System Contract 1.23.4
...
The driver records its selected options and controllerVersion 1.23.4. Model
...
harness and mirror relationship in `manifests/1.23.4.json`. Sources must match
