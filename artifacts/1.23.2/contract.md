# Development System Contract 1.23.2
...
The driver records its selected options and controllerVersion 1.23.2. Model
...
harness and mirror relationship in `manifests/1.23.2.json`. Sources must match
