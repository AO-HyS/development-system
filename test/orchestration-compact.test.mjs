...
test("clear orchestration requests low and escalation requests medium", () => {
  ...
  assert.equal(plain.selected.reasoning, "low");
  assert.equal(escalated.selected.reasoning, "medium");
