...
} from "../artifacts/1.8.0/skills/internal/working-backwards/scripts/t3-reader.mjs";
...
test("final reports keep requested prompt and handoff content reviewable with explicit known-issue dispositions", async () => {
  const skill = await readFile(new URL("../artifacts/1.8.0/skills/internal/working-backwards/SKILL.md", import.meta.url), "utf8");
