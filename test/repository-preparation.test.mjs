...
test("initialization is idempotent, stack-aware, and preserves product identity, design, commands, and release policy", async () => {
  ...
  assert.equal(contract.contractVersion, "1.8.3");
  ...
  assert.equal(contract.operatorPrerequisites.skillCatalogVersion, "0.29.3");
  ...
  assert.match(initialized[".codex/development-system/repository.md"], /Contract version: `1\.8\.3`/);
  ...
  assert.match(initialized[".codex/development-system/repository.md"], /skill catalog `0\.29\.2`/i);
