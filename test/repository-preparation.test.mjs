...
test("initialization is idempotent, stack-aware, and preserves product identity, design, commands, and release policy", async () => {
  ...
  assert.equal(contract.operatorPrerequisites.skillCatalogVersion, "0.9.0");
  ...
  assert.match(initialized[".codex/development-system/repository.md"], /Contract version: `1\.5\.0`/);
