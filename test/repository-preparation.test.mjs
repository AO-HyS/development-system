...
test("initialization is idempotent, stack-aware, and preserves product identity, design, commands, and release policy", async () => {
  ...
  assert.match(initialized[".codex/development-system/repository.md"], /Contract version: `1\.5\.18`/);
  ...
  assert.match(initialized[".codex/development-system/repository.md"], /skill catalog `0\.25\.0`/i);
