# ADR 0056: Field-notebook reports and margin questions
...
Publish immutable contract 1.29.0 and catalog 0.48.0; only the copied working-backwards skill changes. Preserve all prior manifests, artifacts and catalogs. Opening a report never installs software, sends data off the machine or grants release authority.

Imported from reviewed report candidate fb6b5dd968281cd1a5c5563b940047102982a2fa. Release 1.29.0 integrates this report with the advisory execution profile; the report behavior is retained; the only initial integration correction is a JSDoc number annotation for strict typecheck.
